...
function adjustResumeLink() {
  ...
  const resumeLink = document.querySelector('a[href="pages/resume.html"]'); // Select the Resume link
  ...
  if (screenWidth <= 514) {
    ...
    resumeLink.href = "pages/resume.html"; // Normal link to the resume page
  }
}
